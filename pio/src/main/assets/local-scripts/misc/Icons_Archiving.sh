...
curl -skLJo "$SDCARD_PATH/Documents/${string_addonfolder}/${string_archievedicons}.zip" "https://miuiicons-generic.pkg.coding.net/icons/files/Icons_Archiving.zip?version=latest"
